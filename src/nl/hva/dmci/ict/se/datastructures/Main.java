...
import static nl.hva.dmci.ict.se.datastructures.Quicksort.quickSort11;
...
public class Main {
    ...
    public static void opdracht1(){
        ...
        Student[] lijst1; /* Lijst van studenten (in array-vorm) (10.000) */
        Student[] lijst2; /* Lijst van studenten (in array-vorm) (20.000) */
        Student[] lijst3; /* Lijst van studenten (in array-vorm) (40.000) */
        Student[] lijst4; /* Lijst van studenten (in array-vorm) (80.000) */
        Student[] lijst5; /* Lijst van studenten (in array-vorm) (160.000) */
        long[] tijden=new long[10]; /* Array die de tijden bijhoudt */

        /* Genereert de studenten willekeurig */
        lijst1=StudentGenerator.genereerStudenten(100000);
        lijst2=StudentGenerator.genereerStudenten(200000);
        lijst3=StudentGenerator.genereerStudenten(400000);
        lijst4=StudentGenerator.genereerStudenten(800000);
        lijst5=StudentGenerator.genereerStudenten(1600000);
